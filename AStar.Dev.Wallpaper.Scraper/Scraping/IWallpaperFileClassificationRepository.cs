...
{
    /// <summary>
    ///     Determines whether a file already exists at the given directory and name.
    /// </summary>
    ...
    Task<bool> IsAlreadyDownloadedAsync(string directoryPath, string fileName, CancellationToken token);
